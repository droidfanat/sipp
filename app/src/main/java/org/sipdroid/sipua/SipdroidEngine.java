...
//        if(suffix==""){
//        
//        Context Silena_contex = getUIContext();   
//        user_profile.username = Silena_contex.getSharedPreferences("silenaVars",0).getString(MainConstant.SAVED_USERID, suffix);    
//        user_profile.passwd= Silena_contex.getSharedPreferences("silenaVars",0).getString(MainConstant.SIP_PASSWORD,"");
//        user_profile.realm= Silena_contex.getSharedPreferences("silenaVars",0).getString(MainConstant.SIP_REALM, "");
//        user_profile.realm_orig= Silena_contex.getSharedPreferences("silenaVars",0).getString(MainConstant.SIP_REALM_ORIG, "");       
//        user_profile.from_url= Silena_contex.getSharedPreferences("silenaVars",0).getString(MainConstant.SIP_FROM_URL, "");
//        user_profile.qvalue=  Silena_contex.getSharedPreferences("silenaVars",0).getString(MainConstant.SIP_QVALUE, "");     
//        user_profile.mmtel=  Silena_contex.getSharedPreferences("silenaVars",0).getBoolean(MainConstant.SIP_MMTEL,true);
//        user_profile.pub=  Silena_contex.getSharedPreferences("silenaVars",0).getBoolean(MainConstant.SIP_PUB,true);      
//        }
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile suffix :" + suffix);      
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile user_profile.username :" + user_profile.username); 
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile user_profile.passwd :" + user_profile.passwd);  
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile user_profile.realm :" + user_profile.realm);  
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile user_profile.realm_orig :" + user_profile.realm_orig);  
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile  user_profile.from_url :" +  user_profile.from_url);
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile user_profile.qvalue :" + user_profile.qvalue);
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile user_profile.mmtel :" + user_profile.mmtel);
//           Log.d(MainConstant.LOG_TAG, "Engine user_profile user_profile.pub :" + user_profile.pub);
//           
//        return user_profile;
//        
//        
